          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Danh sách sản phẩm</h6>
                ...
                <form action="http://localhost/lordsmobile/www/mvc/index.php?controller=product&action=index" method="GET">
                  <div class = "row">  
                        ...
                        <div class ="col-sm-2">
                            <a href="<?=BASE_PATH.'index.php?controller=product&action=add'?>" class="btn btn-info">Thêm mới</a>
                        </div>  
                  </div>
                </form>
          </div>
                  ...
                  <tbody>
                    <?php foreach($this->data as $key=> $obj){ ?>
                        <tr>
                          ...
                          <td>
                              <?php 
                                $url_stt = BASE_PATH.'index.php?controller=product&action=ChangeStatus&id='.$obj->id.'&status='.$obj->status;
